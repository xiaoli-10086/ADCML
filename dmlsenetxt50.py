...
path5 = "./ckpt/save/aug/aug_multi_se5_NO5_e400_fa_model_best_DML_1_lr001_newdataALL.pth.tar"
# gpu_id = "0,1,2"
...
seresxt50, g_, h_ = loader_model1(9, "se_resnext50", path5)
from senet.newsext50 import se_resnext50_32x4d
class Net(nn.Module):
    def __init__(self):
        super(Net, self).__init__()
        self.model = se_resnext50_32x4d(pretrained=None, num_classes=9)
        # self.model = se_resnet152(pretrained=None, num_classes=9)
        checkpoint = torch.load(path5)
