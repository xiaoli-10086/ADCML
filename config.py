...
misc_arg.add_argument('--traindata_dir', type=str, default="/DATA/LWN/new experiment2（复件）/data/COVID-CT-TEST/train",
                      help='Directory in which data is stored')
misc_arg.add_argument('--predictdata_dir', type=str, default='/DATA/LWN/new experiment2（复件）/data/COVID-CT-TEST/test',
                      help='Directory in which data is stored')
